...
function HideAndShow(e, t) {
    ...
    s || (s = $("#login_panel")), s.animate({
        opacity: 0
    }, "fast", function () {
        s.hide(), ".container" == e ? $(".login-content").hide() : $(".login-content").show(), e && ((e = $(e)).show(), e.css("opacity", "0"), e.animate({
            opacity: 1
        }, "slow", t))
    })
}
...
function ClearRoomContent() {
    ...
    $(function () {
        $(".login-content").on("click", ".panel_item", e), $(".container").on("click", r), $(".role-list").on("click", ".role-item", function () {
            ...
            }), $(".channel-box").on("click", "span", m), $(".combat-commands").on("click", ".pfm-item", j.Perform), $(".sender-box").on("keyup", y), $(".room_items").on("click", ".room-item", T.selectItem), $(".right-bar,.bottom-bar").on("click", ".tool-item", d), $(".map-panel").on("click", function () {
                ...
                A.LoadMap()
            }), $(".validnum-box>.validnum-btn").on("click", a), T.init(),
            function () {
                if (!h("p")) {
    ...
    function a() {
        ...
        if (!e.is(":disabled")) {
            ...
            G.UserAPI.SendValidateCode(s, function (e) {}), e.prop("disabled", !0), e.html("120秒后重新发送"),
                function e(t, s) {
        ...
        if (!n) return k("正在获取服务器列表"), void G.UserAPI.GetServer(function (e) {
            e && "string" != typeof e ? (n = e || [], function () {
                ...
                try {
                    ...
                    for (var e = [], t = ["武神传说", "武神传说", "武神传说", "武神传说"], s = 0; s < n.length; s++) n[s].IsTest && "?test" != window.location.search && "localhost" != window.location.hostname ? n.splice(s, 1) : (e.push("<li class='role-item"), 0 == s && e.push(" select"), e.push("' index='" + s + "'>"), e.push(t[s]), e.push("&nbsp;&nbsp;"), e.push(n[s].Name), e.push("</li>"));
            ...
            InitTools: function () {
                ...
                if (0 == e) {
                    ...
                    if (this.ToolOpacity -= 20, 0 <= t) window.setTimeout(this.ShowToolsAnimate.bind(this, e), 100);
                        ...
                        for (s = this.ToolState = 0; s < this.Tools.length; s++) this.Tools[s].style.display = "none"
                }
    ...
    var enemyid = []
    var enemyname = []
    function jiexidata(e){
    var jx_ch = e.ch;
    var jx_content = e.content;
    var jx_name = e.name;
    if(jx_ch == "sys"){
        //alert(e.name);
        if (jx_content.indexOf("听说") >=0) {
            if (jx_content.indexOf("一带。") >=0) {
                yjbossq = jx_content.substring(jx_content.indexOf("出现在") + 3,jx_content.indexOf("-"));
                yjbossh = jx_content.substring(jx_content.indexOf("-") + 1,jx_content.indexOf("一带。"));
                c("tm" + " " + yjbossh+"");
            }
        }
    }
    ...
    if (e.type == "items"){
        ...
        enemyname =[];
                ...
                for (var i =0;i<e.items.length-1;i++)
                {
                    //alert(e.items[i].id);
                    enemyid.push(e.items[i].id);
                    enemyname.push(e.items[i].name);
                    //c("look" + " " + e.items[i].id+"");        
                }
                //c("look" + " " + enemyid[0]+"");

                // alert(enemyid[0] +"," + enemyname[0]);

        }
    }
    
var maplujin;function cuansong(city,site){switch(city){case"武当派":switch(site){case"广场":maplujin="wd/guangchang";c("jh fam 1 start");break;case"三清殿":maplujin="wd/sanqing";c("jh fam 1 start");c("go north");break;case"石阶":maplujin="wd/shijie1";c("jh fam 1 start");c("go west");break;case"练功房":maplujin="wd/liangong";c("jh fam 1 start");c("go west");c("go west");break;case"太子岩":maplujin="wd/taiziyan";c("jh fam 1 start");c("go west");c("go northup");break;case"桃园小路":maplujin="wd/tylu";c("jh fam 1 start");c("go west");c("go northup");c("go north");break;case"舍身崖":maplujin="wd/sheshen";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go east");break;case"南岩峰":maplujin="wd/nanyan";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");break;case"乌鸦岭":maplujin="wd/wuya";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");break;case"五老峰":maplujin="wd/wulao";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");break;case"虎头岩":maplujin="wd/hutou";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");c("go northup");break;case"朝天宫":maplujin="wd/chaotian";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");c("go northup");c("go north");break;case"三天门":maplujin="wd/santian";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");c("go northup");c("go north");c("go north");break;case"紫金城":maplujin="wd/zijin";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");c("go northup");c("go north");c("go north");c("go north");break;case"林间小径":maplujin="wd/xiaolu";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");c("go northup");c("go north");c("go north");c("go north");c("go north");break;case"林间小径2":maplujin="wd/xiaolu2";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");c("go northup");c("go north");c("go north");c("go north");c("go north");c("go north");break;case"后山小院":maplujin="wd/xiaoyuan";c("jh fam 1 start");c("go west");c("go northup");c("go north");c("go west");c("go northup");c("go northup");c("go northup");c("go north");c("go north");c("go north");c("go north");c("go north");c("go north");break}break;case"少林派":switch(site){case"广场":maplujin="shaolin/guangchang";c("jh fam 2 start");break;case"山门殿":maplujin="shaolin/shanmen";c("jh fam 2 start");c("go north");break;case"西侧殿":maplujin="shaolin/liangong2";c("jh fam 2 start");c("go north");c("go west");break;case"东侧殿":maplujin="shaolin/liangong1";c("jh fam 2 start");c("go north");c("go east");break;case"天王殿":maplujin="shaolin/twdian";c("jh fam 2 start");c("go north");c("go north");break;case"大雄宝殿":maplujin="shaolin/daxiong";c("jh fam 2 start");c("go north");c("go north");c("go northup");break;case"鼓楼":maplujin="shaolin/gulou";c("jh fam 2 start");c("go north");c("go north");c("go northwest");break;case"钟楼":maplujin="shaolin/zhonglou";c("jh fam 2 start");c("go north");c("go north");c("go northeast");break;case"后殿":maplujin="shaolin/houdian";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");break;case"练武场":maplujin="shaolin/lianwu";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");break;case"般若堂":maplujin="shaolin/banruo";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go west");break;case"罗汉堂":maplujin="shaolin/luohan";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go east");break;case"方丈楼":maplujin="shaolin/fangzhang";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go north");break;case"达摩院":maplujin="shaolin/damo";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go north");c("go west");break;case"戒律院":maplujin="shaolin/jielv";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go north");c("go east");break;case"竹林":maplujin="shaolin/zhulin1";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go north");c("go north");break;case"藏经阁":maplujin="shaolin/cangjing";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go north");c("go north");c("go west");break;case"竹林2":maplujin="shaolin/zhulin2";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go north");c("go north");c("go north");break;case"达摩洞":maplujin="shaolin/damodong";c("jh fam 2 start");c("go north");c("go north");c("go northeast");c("go northwest");c("go north");c("go north");c("go north");
c("go north");c("go north");break}break;case"华山派":switch(site){case"镇岳宫":maplujin="huashan/zhenyue";c("jh fam 3 start");break;case"苍龙岭":maplujin="huashan/canglong";c("jh fam 3 start");c("go eastup");break;case"舍身崖":maplujin="huashan/sheshen";c("jh fam 3 start");c("go eastup");c("go southup");break;case"峭壁":maplujin="huashan/qiaobi";c("jh fam 3 start");c("go eastup");c("go southup");c("jumpdown");break;case"山谷":maplujin="huashan/shangu";c("jh fam 3 start");c("go eastup");c("go southup");c("jumpdown");c("go southup");break;case"山间平地":maplujin="huashan/pingdi";c("jh fam 3 start");c("go eastup");c("go southup");c("jumpdown");c("go southup");c("go south");break;case"林间小屋":maplujin="huashan/xiaowu";c("jh fam 3 start");c("go eastup");c("go southup");c("jumpdown");c("go southup");c("go south");c("go east");break;case"玉女峰":maplujin="huashan/yunv";c("jh fam 3 start");c("go westup");break;case"玉女祠":maplujin="huashan/yunvci";c("jh fam 3 start");c("go westup");c("go west");break;case"练武场":maplujin="huashan/lianwu";c("jh fam 3 start");c("go westup");c("go north");break;case"练功房":maplujin="huashan/liangong";c("jh fam 3 start");c("go westup");c("go north");c("go east");break;case"客厅":maplujin="huashan/keting";c("jh fam 3 start");c("go westup");c("go north");c("go north");break;case"偏厅":maplujin="huashan/pianting";c("jh fam 3 start");c("go westup");c("go north");c("go north");c("go east");break;case"寝室":maplujin="huashan/woshi";c("jh fam 3 start");c("go westup");c("go north");c("go north");c("go north");break;case"玉女峰山路":maplujin="huashan/shanlu";c("jh fam 3 start");c("go westup");c("go south");break;case"玉女峰小径":maplujin="huashan/xiaojing";c("jh fam 3 start");c("go westup");c("go south");c("go southup");break;case"思过崖":maplujin="huashan/siguoya";c("jh fam 3 start");c("go westup");c("go south");c("go southup");c("go southup");break;case"山洞":maplujin="huashan/hole";c("jh fam 3 start");c("go westup");c("go south");c("go southup");c("go southup");c("break bi");c("go enter");break;case"长空栈道":maplujin="huashan/zhandao";c("jh fam 3 start");c("go westup");c("go south");c("go southup");c("go southup");c("break bi");c("go enter");c("go westup");break;case"落雁峰":maplujin="huashan/luoyan";c("jh fam 3 start");c("go westup");c("go south");c("go southup");c("go southup");c("break bi");c("go enter");c("go westup");c("go westup");break}break;case"峨眉派":switch(site){case"金顶":maplujin="emei/jinding";c("jh fam 4 start");break;case"睹光台":maplujin="emei/duguangtai";c("jh fam 4 start");c("go northup");break;case"华藏庵":maplujin="emei/huacang";c("jh fam 4 start");c("go northup");c("go east");break;case"庙门":maplujin="emei/miaomen";c("jh fam 4 start");c("go west");break;case"广场":maplujin="emei/guangchang";c("jh fam 4 start");c("go west");c("go south");break;case"大殿":maplujin="emei/dadian";c("jh fam 4 start");c("go west");c("go south");c("go south");break;case"走廊":maplujin="emei/zoulang2";c("jh fam 4 start");c("go west");c("go south");c("go west");break;case"练功房":maplujin="emei/liangong";c("jh fam 4 start");c("go west");c("go south");c("go west");c("go west");break;case"走廊2":maplujin="emei/zoulang4";c("jh fam 4 start");c("go west");c("go south");c("go west");c("go north");break;case"小屋":maplujin="emei/xiaowu";c("jh fam 4 start");c("go west");c("go south");c("go west");c("go north");c("go north");break;case"走廊3":maplujin="emei/zoulang3";c("jh fam 4 start");c("go west");c("go south");c("go west");c("go south");break;case"清修洞":maplujin="emei/qingxiu";c("jh fam 4 start");c("go west");c("go south");c("go west");c("go south");c("go south");break;case"走廊4":maplujin="emei/qingxiu1";c("jh fam 4 start");c("go west");c("go south");c("go east");break;case"厨房":maplujin="emei/chufang";c("jh fam 4 start");c("go west");c("go south");c("go east");c("go east");break;case"休息室":maplujin="emei/xiuxishi";c("jh fam 4 start");c("go west");c("go south");c("go east");c("go south");break}break;case"逍遥派":switch(site){case"青草坪":maplujin="xiaoyao/qingcaop";c("jh fam 5 start");break;case"林间小道":maplujin="xiaoyao/linjian3";c("jh fam 5 start");c("go west");break;case"休息室":maplujin="xiaoyao/xiuxishi";c("jh fam 5 start");c("go west");c("go south");break;case"林间小道2":maplujin="xiaoyao/linjian";c("jh fam 5 start");c("go east");break;case"木板路":maplujin="xiaoyao/muban";c("jh fam 5 start");c("go east");c("go south");break;case"工匠屋":maplujin="xiaoyao/muwu3";c("jh fam 5 start");c("go east");c("go south");c("go south");break;case"练功房":maplujin="xiaoyao/liangong";c("jh fam 5 start");c("go east");c("go north");break;case"林间小道3":maplujin="xiaoyao/linjian1";c("jh fam 5 start");c("go north");break;case"木屋":maplujin="xiaoyao/muwu2";c("jh fam 5 start");c("go north");c("go north");break;case"林间小道4":maplujin="xiaoyao/linjian2";c("jh fam 5 start");c("go south");break;case"木屋":maplujin="xiaoyao/muwu1";c("jh fam 5 start");c("go south");c("go south");break;case"地下石室":maplujin="xiaoyao/shishi";c("jh fam 5 start");c("go down");break;case"地下石室2":maplujin="xiaoyao/shishi2";c("jh fam 5 start");c("go down");c("go down");
break}break;case"丐帮":switch(site){case"树洞内部":maplujin="gaibang/shudong";c("jh fam 6 start");break;case"树洞下":maplujin="gaibang/shudongxia";c("jh fam 6 start");c("go down");break;case"暗道":maplujin="gaibang/andao1";c("jh fam 6 start");c("go down");c("go east");break;case"暗道2":maplujin="gaibang/andao2";c("jh fam 6 start");c("go down");c("go east");c("go east");break;case"破庙密室":maplujin="gaibang/mishi";c("jh fam 6 start");c("go down");c("go east");c("go east");c("go east");break;case"土地庙":maplujin="gaibang/pomiao";c("jh fam 6 start");c("go down");c("go east");c("go east");c("go east");c("go up");break;case"暗道3":maplujin="gaibang/andao3";c("jh fam 6 start");c("go down");c("go east");c("go east");c("go east");c("go east");break;case"暗道4":maplujin="gaibang/andao4";c("jh fam 6 start");c("go down");c("go east");c("go east");c("go east");c("go east");c("go east");break;case"林间小屋":maplujin="gaibang/xiaowu";c("jh fam 6 start");c("go down");c("go east");c("go east");c("go east");c("go east");c("go east");c("go up");break}break;case"扬州城":switch(site){case"广场":maplujin="yz/guangchang";c("jh fam 0 start");break;case"钱庄":maplujin="yz/qianzhuang";c("jh fam 0 start");c("go north");c("go west");c("store");break;case"有间客栈":maplujin="yz/kedian";c("jh fam 0 start");c("go north");c("go east");c("zhudian louh2133719");break;case"醉仙楼":maplujin="yz/zuixianlou";c("jh fam 0 start");c("go north");c("go north");c("go east");c("list n70x2133719");break;case"武庙":maplujin="yz/wumiao";c("jh fam 0 start");c("go north");c("go north");c("go west");break;case"江边":maplujin="yz/hanshui";c("jh fam 0 start");c("go north");c("go north");c("go north");c("go north");c("diao");break;case"当铺":maplujin="yz/dangpu";c("jh fam 0 start");c("go south");c("go east");c("list 7ap72133719");break;case"赌场":maplujin="yz/duchang";c("jh fam 0 start");c("go south");c("go west");break;case"帮派驻地":maplujin="yz/banghui";c("jh fam 0 start");c("go south");c("go south");c("go east");break;case"扬州武馆":maplujin="yz/wuguan";c("jh fam 0 start");c("go south");c("go south");c("go west");c("cha i3vb2133719");break;case"谷物加工厂":maplujin="yz/work";c("jh fam 0 start");c("go south");c("go south");c("go south");c("go west");c("work");break;case"杂货铺":maplujin="yz/zahuopu";c("jh fam 0 start");c("go east");c("go south");c("list wn382133719");break;case"书院":maplujin="yz/shuyuan";c("jh fam 0 start");c("go east");c("go north");c("cha 9f252133719");break;case"成衣店":maplujin="yz/garments";c("jh fam 0 start");c("go east");c("go south");c("go up");break;case"药铺":maplujin="yz/yaopu";c("jh fam 0 start");c("go east");c("go east");c("go north");c("list 36ua2133719");break;case"内室":maplujin="yz/neishi";c("jh fam 0 start");c("go east");c("go east");c("go north");c("north");c("lianyao");break;case"打铁铺":maplujin="yz/datiepu";c("jh fam 0 start");c("go east");c("go east");c("go south");c("list 2l8w2133719");break;case"药林":maplujin="yz/yaolin";c("jh fam 0 start");c("go east");c("go east");c("go east");c("go south");c("cai");break;case"擂台":maplujin="z/leitai/ltx";c("jh fam 0 start");c("go west");c("go west");break;case"衙门正厅":maplujin="yz/ymzhengting";c("jh fam 0 start");c("go west");c("go north");c("go north");c("ask1 0q8v2133719");break;case"福威镖局":maplujin="yz/biaoju";c("jh fam 0 start");c("go west");c("go west");c("go south");break;case"镖局正厅":maplujin="yz/zhengting";c("jh fam 0 start");c("go west");c("go west");c("go south");c("go south");break;case"矿山":maplujin="yz/kuang";c("jh fam 0 start");c("go west");c("go west");c("go west");c("go west");c("wa");break}break;case"住房":switch(site){case"练功房":maplujin="home/liangong";c("jh fam 0 start");c("go west");c("go west");c("go north");c("go enter");c("go west");break;case"小花园":maplujin="home/huayuan";c("jh fam 0 start");c("go west");c("go west");c("go north");c("go enter");c("go northeast");break;case"炼药房":maplujin="home/lianyao";c("jh fam 0 start");c("go west");c("go west");c("go north");c("go enter");c("go east");break}break}};

var yjzbq;
var yjzbh;
function yijianzb(e){
    if  (e.indexOf("你不是在追捕吗？ 如果你不想干，就放弃吧。") >=0) {
        c("ask2 0q8v2133719");
        c("ask1 0q8v2133719");
        
    }
    if  (e.indexOf("程药发对你说道") ==0) {
        if  (e.indexOf("作恶多端") >=0){
            yjzbq = e.substring(e.indexOf("最近在") + 3,e.indexOf("-"));
            yjzbh = e.substring(e.indexOf("-") + 1,e.indexOf("出现过"));

            //alert("出现在门派：" + yjzbq + ",地址:" + yjzbh)
            cuansong(yjzbq,yjzbh);
        }
    }
}

function dropall(){var dropItemSelectIndexmax=$(".obj-list div.obj-item").length;for(var i=0;i<=$(".obj-list div.obj-item").length;i++){dropItemSelectIndexmax=dropItemSelectIndexmax-1;console.log(dropItemSelectIndexmax);var curItem=$(".obj-list div.obj-item:eq("+dropItemSelectIndexmax+")");curItem.click();var packitemid=$(".obj-list div.obj-item:eq("+dropItemSelectIndexmax+")").html();if(packitemid.indexOf("wht")!=-1){if(packitemid.indexOf("铁镐")==-1){if(packitemid.indexOf("钥匙")==-1){if(packitemid.indexOf("山楂叶")==-1){if(packitemid.indexOf("当归")==-1){if(packitemid.indexOf("芦荟")==-1){if(packitemid.indexOf("鱼饵")==-1){if(packitemid.indexOf("鲤鱼")==-1){if(packitemid.indexOf("鲢鱼")==-1){if(packitemid.indexOf("草鱼")==-1){if(packitemid.indexOf("头颅")==-1){var abccc=$(".item-commands").html();var dropallid=abccc.substring(abccc.indexOf("_confirm")+9,abccc.indexOf(">丢掉")-1);c(dropallid)}}}}}}}}}}}}};

function onRoomItemSelect(select) {
    $(".room_items div.room-item").eq(select).click();
}
    ...
    var T = {
            ...
            clear: function () {
                ...
                if (t) {
                    ...
                    var i = t.elem.parent();
                    i.next().is(".item-commands") && i.next().remove(), i.remove(), delete j.STATUS[e.id]
                }
            }, itemadd: function (e) {
                if (!R.off_plist || !e.p || e.id == T.player) {
                    var t, s = e;
                    t = R.item_firstme && s.id == T.player ? $(T.create_roomitem(s)).prependTo(T.itemsElement) : $(T.create_roomitem(s)).appendTo(T.itemsElement), j.STATUS[e.id] && T.itemremove(e), j.AppendStatusItem(s.id, t.find(".item-status-bar"), s.status)
                }
            }, items: function (e) {
                T.itemsElement.empty(), j.STATUS = {};
                for (var t = 0; t < e.items.length; t++) {
                    var s, i = e.items[t];
                    if (i)
                        if (!R.off_plist || !i.p || i.id == T.player) s = R.item_firstme && i.id == T.player ? $(T.create_roomitem(i)).prependTo(T.itemsElement) : $(T.create_roomitem(i)).appendTo(T.itemsElement), j.AppendStatusItem(i.id, s.find(".item-status-bar"), i.status)
                }
            }, create_roomitem: function (e) {
                var t = [];
                return t.push("<div class='room-item' itemid='" + e.id + "'>"), e.max_hp && (t.push('<div class="item-status"'), j.IsShow || R.show_hp || t.push(' style="display:none;"'), t.push(">"), t.push('<div class="progress hp"><div class="progress-bar" max="' + e.max_hp + '"  style="width:' + T.countwidth(e.hp, e.max_hp) + '%"></div></div>'), t.push('<div class="progress mp"><div class="progress-bar" max="' + e.max_mp + '"   style="width:' + T.countwidth(e.mp, e.max_mp) + '%"></div></div>'), t.push("</div>")), t.push("<span class='item-status-bar'>"), t.push("</span>"), t.push("</span>"), t.push("<span class='item-name'>"), t.push(e.name), t.push("</span>"), t.push("</div>"), t.join("")
            }, room: function (e) {
                if ($(".room_items").html(""), $(".room-name").html(e.name), $(".room_desc").html(e.desc), T.room_name = e.name, !R.keep_msg && f ? (f.remove(), f = null, b = 0) : R.keep_msg && S("你来到了" + e.name + "。"), T.room_path != e.path) {
                    j.ShowRoomCommands(e.commands), T.room_path = e.path, A.SetRoom(e)
                }
            }, exits: function (e) {
                var t = e ? e.items : T.room_exits;
                if (t)
                    if (T.room_exits = t, R.exits_dir) {
                ...
                var t = $(e.target);
                t.is("rect") ? t.attr("fill", "gray") : t.is("text") && t.prev().attr("fill", "gray")
            }, click_exits: function (e) {
                var t = $(e.target),
                    s = t.attr("dir");
                t.is("rect") ? t.attr("fill", "#232323") : t.is("text") && t.prev().attr("fill", "#232323"), s && c("go " + s)
            }, item: function (e) {
                if (S(e.desc), e.commands) {
                    ...
                    if (t.push("</div>"), R.show_command && j.STATUS[e.id]) {
                        T.itemsElement.find(".item-commands").remove();
                        var i = j.STATUS[e.id].elem.parent();
                ...
                j.ClearDistime(e)
            }, pay: function (e) {}, dispfm: function (e) {
                j.On_Perform(e)
            }, status: function (e) {
                j.StatusItemChanged(e)
            }, combat: function (e) {
                e.start && (1 != R.auto_showcombat || j.IsShow || j.Show(), 1 == R.auto_hideroom && (R.hide_roomdesc || $(".room_desc").hide())), e.end && 1 == R.auto_hideroom && (R.hide_roomdesc || $(".room_desc").show())
            }, state: function (e) {
                if (e && e.state) {
                    var t = ["<span class='title'>" + e.state + "</span>"];
                    if (e.commands)
                        for (var s = 0; s < e.commands.length; s++) t.push("<span class='item-command' cmd='" + e.commands[s].cmd + "'>"), t.push(e.commands[s].name), t.push("</span>");
                ...
                j.AddObj(e.id, e.name, e.distime)
        ...
        E = {
            ...
            Show: function (e) {
                ...
                for (var e = 0, t = 0; t < E.Elemes.length; t++) {
                    var s = E.Elemes[t];
        ...
        j = {
            ...
            Skills: null,
            Show: function () {
                if (j.IsShow) return j.Hide();
                this.Actions || c("actions"), j.IsShow = !0, R.show_hp || $(".room-item>.item-status").show(), $(".combat-panel").removeClass("hide"), $(".right-bar")[0].style.bottom = "7em"
            }, Hide: function () {
                j.IsShow = !1, R.show_hp || $(".room-item>.item-status").hide(), $(".combat-panel").addClass("hide"), $(".right-bar")[0].style.bottom = null
            }, ShowRoomCommands: function (e) {
                if (this.RoomCommands)
                    for (var t = 0; t < this.RoomCommands.length; t++) this.RoomCommands[t].elem && this.RoomCommands[t].elem.remove();
                ...
                if (this.Actions)
                    for (var t = this.Actions.concat(this.RoomCommands || []), s = $(".room-commands"), i = 0; i < t.length; i++)
                        if (!t.elem) {
                            var n = t[i],
                                o = [];
                ...
                if (this.Actions)
                    for (var t = "use " + e.id, s = 0; s < this.Actions.length; s++) {
                ...
                if (e) {
                    ...
                    e.style.left = i + "%", setTimeout(j.ANI_OBJ, 1e3, e, t, s + 1e3)
                }
                ...
                for (var t = e.id.replace("/", "."), s = 0; s < j.dis_pfms.length; s++)
                    if (j.dis_pfms[s].id == t) {
                        j.dis_pfms[s].ani_time += e.time;
                        break
                    }
            }, ClearDistime: function (e) {
                if (j.dis_pfms)
                    for (var t = e.id ? e.id.replace("/", ".") : e.id, s = 0; s < j.dis_pfms.length; s++) {
                        if (t && "all" != t && j.dis_pfms[s].id == t) {
                            j.dis_pfms[s].ani_time = 0;
                            break
                        }
                        j.dis_pfms[s].ani_time = 0
                    }
                ...
                if (this.Skills) {
                    ...
                    e.id && this.dis_pfms.push({
                        ...
                        distime: e.distime,
                        ani_time: e.distime
                    }), j.ani_time = j.ani_time || 0, e.rtime > j.ani_time && (j.distime = e.rtime, j.ani_time = e.rtime), this.time_handler || j.ANI_PFM()
                }
            }, PFM_INTERVAL: 300,
            ANI_PFM: function () {
                for (var e = 100 * j.ani_time / j.distime, t = 0; t < j.Skills.length; t++) {
                    for (var s = j.Skills[t], i = e, n = 0; n < j.dis_pfms.length; n++)
                        if (j.dis_pfms[n].id == s.id && j.dis_pfms[n].distime) {
                            (i = 100 * j.dis_pfms[n].ani_time / j.dis_pfms[n].distime) < 0 ? j.dis_pfms.splice(n, 1) : j.dis_pfms[n].ani_time -= j.PFM_INTERVAL;
                            break
                        }
                    0 < i ? (s.shadow.style.left = 100 - i + "%", s.shadow.style.display = "block") : (s.shadow.style.display = "none", s.shadow.style.left = "0px")
                }
                0 < j.ani_time || j.dis_pfms.length ? j.time_handler = setTimeout(j.ANI_PFM, j.PFM_INTERVAL) : j.time_handler = null, j.ani_time -= j.PFM_INTERVAL
                ...
                if (null != i) {
                    ...
                    e["max_" + t] ? (n = e["max_" + t], o.attr("max", n)) : n = parseInt(o.attr("max")), o.css("width", j.CountWidth(i, n) + "%")
                }
            }, CountWidth: function (e, t) {
                if (0 == t) return 0;
                var s = 100 * e / t;
                ...
                if (s)
                    for (var n = 0; n < s.length; n++) this.StatusItem_add(i, s[n]);
                this.STATUS[e] = i
            }, StatusItemChanged: function (e) {
                var t = j["StatusItem_" + e.action];
                t && t.call(j, this.STATUS[e.id], e)
                ...
                if (e) {
                    ...
                    }, 0 < t.duration && j.StatusItemANI(e.items[t.sid])
                }
                ...
                if (e) {
                    ...
                    if (s) {
                        ...
                        s.count = t.count, s.elem.innerHTML = s.name + "x" + s.count + i.outerHTML, s.handler && clearTimeout(s.handler), s.anitime = s.duration, j.StatusItemANI(s)
                    }
                }
            }, StatusItem_override: function (e, t) {
                var s = e.items[t.sid];
                s && (s.handler && clearTimeout(s.handler), s.anitime = s.duration, j.StatusItemANI(s))
                ...
                s < 0 && (s = 0), t.style.right = s + "%", e.anitime = e.anitime - 1e3, e.handler = 0 < s ? setTimeout(j.StatusItemANI, 1e3, e) : 0
            }
        };
    var A = {
        ...
        q = {
            ...
            show: function (e, t) {
                ...
                selectIndex: 0,
                onData: function (e) {
                    if (console.log(e), this.data = e, this.init_elem(), q.titleElement.html(e.name), q.icon("user"), e.titles) this.titles = e.titles, this.create_titles();
                    else {
    ...
    q.skills = {
        ...
        showdesc: function (e) {
            ...
            if (this.skills) {
                ...
                } else if (null != e.exp || null != e.level) e.level && (t.level = e.level), e.exp && (t.exp = e.exp), this.updateSkillItem(t);
        ...
        item_click: function () {
            ...
            if (s) {
                if (t.push('<span cmd="checkskill ' + s.id + '">查看详细</span>'), s.can_enables)
                    for (var i = 0; i < s.can_enables.length; i++) {
        ...
        onData: function (e) {
            ...
            if (t) {
                ...
                if (s.push('<span cmd="checkskill ' + t.id + " " + q.master.master + '">查看详细</span>'), s.push('<span cmd="xue ' + e.attr("skid") + " from " + q.master.master + '">学习</span>'), q.master.is_follower) {
                    ...
                    if (s.push('<span cmd="_confirm ' + i + " fangqi " + e.attr("skid") + '">遗忘</span>'), s.push('<span cmd="' + i + " lianxi " + e.attr("skid") + '">练习</span>'), t.can_enables)
                        for (var n = 0; n < t.can_enables.length; n++) {
        ...
        updateitem: function (e) {
            ...
            if (e) {
                if (e.items) this.eqs = e.eqs || [], this.money = e.money, this.items = e.items, this.max_count = e.max_item_count;
                else {
        ...
        onData: function (e) {
            if (this.show(), e.items) this.eqs = e.eqs || [], this.money = e.money, this.id = e.id, this.command_before = "dc " + this.id + " ", this.items = e.items, this.target_name = e.name, this.max_count = e.max_item_count;
        ...
        hide: function () {
            ...
            this.show(), q.title("和" + e.name + "交易中");
            q.pack.items;
        ...
        show: function (e) {
            ...
            if ((e = parseInt(e)) && this.trade_list.length)
                for (e = 0; e < this.trade_list.length; e++) c("give " + this.trade_target + " " + this.trade_list[e].count + " " + this.trade_list[e].id);
            q.hide()
            ...
            for (var t = 0; t < this.trade_list.length; t++)
                if (e.id == this.trade_list[t].id) return this.trade_list[t].count += e.count, this.create_items();
        ...
        init: function () {
            if (!this.settingElement) {
                this.settingElement = $(".dialog-setting"), this.gamesettingElement = $(".dialog-gamesetting"), this.helpElement = $(".dialog-help"), this.systemElement = $(".dialog-system");
            ...
            this.selectitem && this.selectitem.remove(), this.selectitem = this[e + "Element"], "setting" == e ? (this.selectitem.on("click", ".switch", this.switchClick), this.selectitem.on("click", ".color-item", this.colorClick)) : this.selectitem.on("click", ".help-item", this.helpClick), this.selectitem.appendTo(q.contentElement)
        }, helpClick: function () {
            ...
            case "tologin":
                break;
            case "torole":
                T.player = null, HideAndShow("#role_panel");
                break;
            case "toserver":
            ...
            if (s) {
                var i = 0;
                return t.is(".on") ? (t.removeClass("on"), t.find(".switch-text").html("关")) : (t.addClass("on"), t.find(".switch-text").html("开"), i = 1), R.save(s, i), !(e.cancelable = !0)
            }
        }, colorClick: function () {
            var e = $(this);
            if (!e.is(".select")) {
        ...
        onData: function (e) {
            ...
            if (null != e.unRead && (this.unRead = e.unRead), e.messages)
                for (var t = 0; t < e.messages.length; t++) this.addMessage(e.messages[t]);
            ...
            for (var t = 0; t < this.messages.length; t++)
                if (this.messages[t].id == e.id) return void(this.messages[t] = e);
        ...
        create_footer: function () {
            ...
            for (var t = 0; t < this.messages.length; t++)
                if (this.messages[t].id == e) return this.messages[t]
        ...
        createElement: function () {
            ...
            var t = [];
            t.push("<div class='relation-item'>"), e.husband ? (t.push("你的丈夫："), t.push(e.husband)) : e.wife ? (t.push("你的妻子："), t.push(e.wife)) : t.push("你目前没有结婚。"), t.push("</div>"), e.wife && (t.push("<div class='item-commands'>"), t.push("<span cmd='_confirm greet wife'>❀送花❀</span>"), t.push("</div>")), t.push("<div class='relation-item'>"), e.shifu ? (t.push("你的师父："), t.push(e.shifu)) : e.tudi ? (t.push("你的徒弟："), t.push(e.tudi)) : t.push("你目前没有拜师，也没有收徒。"), e.shifu && (t.push("<div class='item-commands'>"), t.push("<span cmd='greet master'>请安</span>"), t.push("</div>")), null != e.st && (t.push("<div class='relation-item'>"), t.push("你本周已完成" + e.st + "次师徒任务。"), t.push("</div>")), e.reward && (t.push("<div class='relation-item'>"), t.push(e.reward), t.push("</div>")), t.push("</div>"), this.element.html(t.join(""))
        }, close: function () {
            this.element.remove(), this.isShow = !1
        }
    }, q.team = {
    ...
    var R = {
            ...
            load: function (e) {
                if (e)
                    for (var t in e) "fullscreen" != t && (this.set_prop(t, e[t]), this[t] = e[t])
                ...
                case "item_firstme":
                    ...
                    break;
                case "show_hp":
                    j.IsShow || (1 == t ? $(".room-item>.item-status").show() : $(".room-item>.item-status").hide());
                    break;
                case "fullscreen":
            ...
            to_c: function (e) {
                ...
                for (var s = e.find("input"), i = 0; i < s.length; i++) {
                    var n = $(s[i]).val(),
                        o = !1;
                    if (t)
                        for (var a = 0; a < t.length; a++) t[a] != n || (o = !0);
    ...
    Array.prototype.Remove = function (e) {
        for (var t = this.length, s = 0; s < t; s++)
            if (this[s] == e) return this.splice(s, 1), this;
        return this
    }, Array.prototype.Has = function (e) {
        for (var t = this.length, s = 0; s < t; s++)
            if (this[s] == e) return !0;
        return !1
